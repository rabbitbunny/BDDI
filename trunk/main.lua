...
if ( arg[1] ~= nil ) then
	print("read commandline args.", arg[1], arg[2])
	for k,v in pairs(arg) do print(k,v) end
else
	print("did not read commandline args.")
end
...
function compareAnyTypes( op1, op2 ) -- Return the comparison result
...
function printvariable( var, name, tabs )
	...
	elseif type(var) == "table" then
		...
		for k,v in pairsByKeys(var) do
			printvariable(v,tostring(k),tabs+1);
		end
